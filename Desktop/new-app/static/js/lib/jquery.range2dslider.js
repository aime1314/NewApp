...
!function($){	
	...
	function init(_this){
		...
		_this.$sliderBox = $('<div class="xdsoft_range2dslider_box xdsoft_range2dslider_box_'+_this.options.x+' xdsoft_range2dslider_box_'+_this.options.y+'"><div class="line "></div></div>'),
		_this.$runners = [];			
	...
	$.fn.range2dslider = $.fn.range2DSlider = function( _options,arg2 ){
		if( typeof(_options)=='string' ){
		 ...
		 return this.each(function(){
			...
			_this.$sliderBox.append(_this.$runners[0]);	
